...
document.addEventListener('DOMContentLoaded', function() {
    ...
    listas.forEach((lista, indice) => {
        ...
        const apellidos = [primerApellido, segundoApellido]
        ...
        nombresCompletos.push(`Integrante ${indice + 1}: "${nombreCompleto}"`);
